...
<head>
    ...
    <!-- Website Title -->
    <title>SISINDUK</title>
    
    <!-- Styles -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,400i,700&display=swap&subset=latin-ext" rel="stylesheet">
    <link href="<?php echo base_url('template/landing/css/bootstrap.css');?>" rel="stylesheet">
    <link href="<?php echo base_url('template/landing/css/fontawesome-all.css');?>" rel="stylesheet">
    <link href="<?php echo base_url('template/landing/css/swiper.css');?>" rel="stylesheet">
	<link href="<?php echo base_url('template/landing/css/magnific-popup.css');?>" rel="stylesheet">
	<link href="<?php echo base_url('template/landing/css/styles.css');?>" rel="stylesheet">
	
	<!-- Favicon  -->
    <link rel="icon" href="<?php echo base_url('template/landing/images/favicon.png');?>">
</head>
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Scripts -->
    <script src="<?php echo base_url();?>template/landing/js/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="<?php echo base_url();?>template/landing/js/popper.min.js"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="<?php echo base_url();?>template/landing/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
    <script src="<?php echo base_url();?>template/landing/js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?php echo base_url();?>template/landing/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="<?php echo base_url();?>template/landing/js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?php echo base_url();?>template/landing/js/validator.min.js"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="<?php echo base_url();?>template/landing/js/scripts.js"></script> <!-- Custom scripts -->
</body>
</html>