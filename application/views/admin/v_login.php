...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url();?>template/admin/index2.html"><b>SISINDUK</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url();?>home" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block" href="home">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<!-- jQuery -->
<script src="<?php echo base_url();?>template/admin/<?php echo base_url();?>template/admin/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
